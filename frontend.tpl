...
<div id="site_wrap">
	...
	<div class="div_header">
      <div class="div_header-right">
        <a style="background-color:white; color: #305A72;" href="?"> Enroll Counts </a>
        <a href="dropouts.html"> Drop Outs </a>
      </div>
      <span>DRE SIS Reports</span>
	...
	<div id="list" class="div_body">
		...
		<select id="schId" onchange="get_data();">
